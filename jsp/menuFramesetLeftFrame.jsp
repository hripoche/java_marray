...
<script src="../js/menu/ua.js"></script>

<!-- Infrastructure code for the tree -->
<script src="../js/menu/ftiens4.js"></script>

<!-- Execution of the code that actually builds the specific tree.
     The variable foldersTree creates its structure with calls to
	 gFld, insFld, and insDoc -->
<script src="../js/menu/framesetNodes.js"></script>
...
<div style="position:absolute; top:0; left:0; "><table border=0><tr><td><font size=-2><a style="font-size:7pt;text-decoration:none;color:silver" href=http://www.treeview.net/treemenu/userhelp.asp target=_top>Tree Menu Help</a></font></td></table></div>
