...
<html>
<head>
  <title>Conversion du format Agilent vers le format ArrayPlot</title>
</head>
...
<h1>Conversion du format Agilent vers le format ArrayPlot</h1>

<form method="post" action="<%= response.encodeURL("/marray/controller") %>" enctype="multipart/form-data">
<input type="hidden" name="action" value="convert_arp">
